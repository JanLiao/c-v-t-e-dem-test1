...
public class DrawerDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        final Scene scene = new Scene(drawersStack, 800, 500);
        final ObservableList<String> stylesheets = scene.getStylesheets();
        stylesheets.addAll(DrawerDemo.class.getResource("jfoenix-components.css").toExternalForm(),
                           DrawerDemo.class.getResource("jfoenix-design.css").toExternalForm());
