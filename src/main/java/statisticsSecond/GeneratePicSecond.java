...
*/
public class GeneratePicSecond extends Application {
...
//		CircleData pan = DataUtil.getAvgCircleData("shipan");
//		CircleData bei = DataUtil.getAvgCircleData("shibei");
		CircleData pan = obj.getPanAvg();
		CircleData bei = obj.getBeiAvg();
		LineData line = DataUtil.getAvgLineData("amd");
		Constant.panAvg = pan;
		Constant.beiAvg = bei;
		Constant.lineAvg = line;
	...
	public static void getMaskNew2(String imgpath, String savepath, 
		...
		for(File f : files) {
			...
			//SaveAll.AllMaskNew1("2___" + name.split("[.]")[0], flag + df.format(num), savepath, obj);
			//SaveAll.allmasknew2("2___" + name.split("[.]")[0], flag + df.format(num), savepath, obj);
			
			
			//SaveAll.allmasknew3("2___" + name.split("[.]")[0], flag + df.format(num), savepath, obj);
